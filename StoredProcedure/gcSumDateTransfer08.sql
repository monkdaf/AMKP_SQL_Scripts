...
GO
/****** Object:  StoredProcedure [dbo].[gcSumDateTransfer08]    Script Date: 9/27/2017 12:47:46 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[gcSumDateTransfer08]
AS
BEGIN
	SET NOCOUNT ON;
	...
	BEGIN
		...
		EXECUTE [dbo].[gcUpdateSumData] @dt = @dt, @ID = 204, @Value = @PE3_29
		EXECUTE [dbo].[gcUpdateSumData] @dt = @dt, @ID = 205, @Value = @TE3_27
		EXECUTE [dbo].[gcUpdateSumData] @dt = @dt, @ID = 206, @Value = @FE3_27
		EXECUTE [dbo].[gcUpdateSumData] @dt = @dt, @ID = 207, @Value = @FE3_27_norm
		EXECUTE [dbo].[gcUpdateSumData] @dt = @dt, @ID = 208, @Value = @FE3_27_norm_Q
